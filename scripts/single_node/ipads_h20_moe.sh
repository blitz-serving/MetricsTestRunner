...
MODEL_PATH='/nvme/models/Qwen3-A3B-30B-Instruct-2025'
...
print_usage() {
    echo "Usage: $0 [--no-backend] [--work-dir DIR] [--venv-path PATH] <backend-cfg> <router-cfg> <client-cfg> <policy>"
    ...
    echo "  --venv-path     Set virtual environment path (default: $VENV_PATH)"
}
