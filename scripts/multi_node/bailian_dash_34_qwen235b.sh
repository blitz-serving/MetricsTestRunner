...
# MODEL_PATH='/home/admin/resource/model/464482ce.qwen3-235b-a22b-fp8/0522/'
# REMOTE_MODEL_PATH='/home/admin/resource/model/464482ce.qwen3-235b-a22b-fp8/0522/'

# MODEL_PATH='/home/admin/resource/model/464482ce.qwen3-235b-a22b/128k-0426/'
# REMOTE_MODEL_PATH='/home/admin/resource/model/464482ce.qwen3-235b-a22b/128k-0426/'

MODEL_PATH='/mnt/debugger/wjh/models/Qwen3-235B-A22B/'
REMOTE_MODEL_PATH='/mnt/debugger/wjh/models/Qwen3-235B-A22B/'
...
wait_for_vllm_startup() {
    ...
    local max_wait_sec=1800 # 30 mins
    local elapsed=0
...
wait_for_remote_vllm_startup() {
    ...
    local max_wait_sec=300 # the remote vllm should already started up, extra 5 mins
    local elapsed=0
    local check_interval=5
