...
POLICIES=(
    ...
    # "bailian-impl-00-deterministic"
    "bailian-impl-01-deterministic"
    # "bailian-impl-02-deterministic"
...
for bs in ${BATCH_SIZES[@]}; do
    ...
    for run_id in 1; do  # Run 3 times: r1, r2, r3
        TAG="batch${bs}_u0.9_flashinfer_1203_mooncake_conv_searchbailianpara_qwen30b_r$run_id"
