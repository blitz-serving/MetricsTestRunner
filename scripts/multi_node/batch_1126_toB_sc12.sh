...
#POLICIES=("round-robin-q" "least-bs-random" "llumnix-linear-04" "llumnix-tuple" "join-shortest-q-weight" "join-shortest-q-tuple" "bailian-impl-06" "bailian-tuple" "dynamo-deterministic" "least-wait-token-q" "least-wait-token-random" "least-wait-token-bs" "least-wait-token-gated-bs" "join-shortest-q-ttft")
...
for bs in ${BATCH_SIZES[@]}; do
    for run_id in 1; do  # Run 3 times: r1, r2, r3
        TAG="batch${bs}_u0.9_flashinfer_1126_toB_sc12_r$run_id"
