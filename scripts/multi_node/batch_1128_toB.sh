...
# 18 policies 25min = 7.5h Actual 8.0h
#POLICIES=("round-robin-q" "least-bs-random" "llumnix-linear-04" "llumnix-tuple" "join-shortest-q-weight" "join-shortest-q-tuple" "bailian-impl-06" "bailian-tuple" "dynamo-deterministic" "least-wait-token-q" "least-wait-token-random" "least-wait-token-bs" "least-wait-token-gated-bs" "least-ttft-bs-tuple")
# "join-shortest-q-ttft" "least-ttft-bs-tuple" "llmd-impl-q" "poly-serve-impl-q" "slo-serve-impl-q"
#POLICIES=("least-wait-token-q" "least-wait-token-random" "llmd-impl-q")
#POLICIES=("least-wait-token-bs" "least-wait-token-gated-bs")
POLICIES=("least-wait-token-mul-bs" "least-wait-token-bs" "least-wait-token-gated-bs")
#POLICIES=("join-shortest-q-ttft" "least-ttft-bs-tuple" "llmd-impl-q" "poly-serve-impl-q" "slo-serve-impl-q")
...
#         TAG="batch${bs}_u0.9_flashinfer_1128_toB_r$run_id"
