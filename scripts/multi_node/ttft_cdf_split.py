...
def plot_error_cdf(preds, reals, threshold, log_dir):
    """
    ...
    plt.grid(alpha=0.3)
    plt.tight_layout()
    plot_path = os.path.join(log_dir, "compare_ttft_prediction.png")
...
def main():
    ...
    plot_error_cdf(preds, reals, args.threshold, log_dir)
