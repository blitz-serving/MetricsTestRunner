...
for bs in ${BATCH_SIZES[@]}; do
    ...
    for run_id in 1; do  # Run 3 times: r1, r2, r3
        ...
        if [[ "$USE_REMOTE" == "True" ]]; then
            BACKEND_CFG="$CONFIG_DIR/launch_vllm_16instances_b${bs}_${MACHINE}.toml"
        else
            BACKEND_CFG="$CONFIG_DIR/launch_vllm_8instances_b${bs}_${MACHINE}.toml"
        fi
        ...
        for sf in ${SCALING_FACTORS[@]}; do
            ...
            for policy in ${POLICIES[@]}; do
                ...
                while [ $retry_count -lt $max_retries ]; do
                    ...
                    if "$SCRIPT_DIR/bailian_dash_flashattn.sh" \
